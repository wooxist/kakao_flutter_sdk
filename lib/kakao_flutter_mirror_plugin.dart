...
//
// class KakaoFlutterMirrorPlugin {
//   static void registerWith(Registrar registrar) {
//     final MethodChannel channel = MethodChannel(
//         "kakao_flutter_mirror", const StandardMethodCodec(), registrar.messenger);
//
//     final KakaoFlutterMirrorPlugin instance = KakaoFlutterMirrorPlugin();
...
//             code: "NotImplemented",
//             details:
//                 "KakaoFlutterMirror for web doesn't implement the method ${call.method}");
//     }
//   }
// }
